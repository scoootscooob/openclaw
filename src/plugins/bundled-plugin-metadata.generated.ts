...
export const GENERATED_BUNDLED_PLUGIN_METADATA = [
  ...
  },
  {
    ...
    packageName: "@openclaw/applehome",
    packageVersion: "2026.3.24",
    packageDescription: "Apple Home (HomeKit) hardware adapter plugin",
    packageManifest: {
      extensions: ["./index.ts"],
    },
    manifest: {
  ...
  },
  {
    ...
    idHint: "homeassistant",
    source: {
      source: "./index.ts",
      built: "index.js",
    },
    packageName: "@openclaw/homeassistant",
    packageVersion: "2026.3.24",
    packageDescription: "Home Assistant hardware adapter plugin",
    packageManifest: {
      extensions: ["./index.ts"],
    },
    manifest: {
  ...
  },
  {
    ...
    packageName: "@openclaw/mijia",
    packageVersion: "2026.3.24",
    packageDescription: "Xiaomi Mijia (MiIO/MiOT) hardware adapter plugin",
    packageManifest: {
      extensions: ["./index.ts"],
    },
    manifest: {
      ...
      name: "Xiaomi Mijia",
      description: "Discover and control Xiaomi smart home devices via MiIO/MiOT protocol.",
      uiHints: {
        token: {
          label: "Device Token",
          sensitive: true,
          help: "32-character hex token for local device communication. See docs for extraction steps.",
        },
        devices: {
          label: "Devices",
  ...
  },
  {
    ...
    packageName: "@openclaw/mqtt",
    packageVersion: "2026.3.24",
    packageDescription: "MQTT hardware adapter plugin",
    packageManifest: {
      extensions: ["./index.ts"],
    },
    manifest: {
